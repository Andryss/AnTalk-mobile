...
import ru.andryss.antalk.mobile.util.PropertyNames.Companion.ANTALK_BASE_URL

val JSON_MEDIA_TYPE = "application/json".toMediaType()

fun AppState.authHeaders() =
    mapOf("Authorization" to "Bearer ${userInfo.sessionToken}")
...
private fun AppState.buildHttpCall(
    ...
    val baseUrl = properties.getProperty(ANTALK_BASE_URL, "http://localhost:8080")
